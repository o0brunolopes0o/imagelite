...
export const Template: React.FC<TemplateProps> = ({children, loading}: TemplateProps) => {
    return (
        <div className="flex flex-col min-h-screen">
            <Header/>
            <div className={`${loading? 'animate-pulse': ''} container mx-auto mt-8 flex-grow`}>
                {children}
...
const Loading: React.FC = () => {
    return (
        <div
            ...
            style={{ backgroundColor: 'rgba(19,19,19,0.3477766106442577)' }}
        >
            <div className="flex flex-col items-center">
                <svg
                    aria-hidden="true"
                    className="w-8 h-8 mb-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                    viewBox="0 0 100 101"
                    fill="none"
